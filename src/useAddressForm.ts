...
import { Form, defineForm } from "./components/form-builder/Field";
import CustomSelect from "./components/form-builder/CustomSelect.vue";
import CustomInput from "./components/form-builder/CustomInput.vue";
import CustomCheckbox from "./components/form-builder/CustomCheckbox.vue";
...
const fetchPostcode = (countryCode) => {
